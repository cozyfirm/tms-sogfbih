...
namespace App\Http\Controllers\TrainerData\Trainings;
...
class TrainingsController extends Controller{
    ...
    protected string $_path = 'trainer-data.trainings.';
    ...
    public function getTrainings($instances, $header): View{
        ...
        $filters = [
            ...
            'applicationsRel.userRel.name' => __('Kandidati na obuci'),
    ...
    public function myTrainings(): View{
        $instances = Instance::whereHas('trainersRel', function ($query){
