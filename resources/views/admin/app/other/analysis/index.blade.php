...
@section('c-buttons')
    ...
    <a href="{{ route('system.admin.other.analysis.create') }}">
...
@section('content')
    <div class="content-wrapper content-wrapper-p-15">
        ...
        @include('admin.layout.snippets.filters.filter-header', ['var' => $analyses])
        ...
        @include('admin.layout.snippets.filters.pagination', ['var' => $analyses])
    </div>
@endsection
