...
<div class="rm-card-icons">
    ...
    <a href="{{ route('system.admin.trainings.instances.submodules.applications.add-application', ['instance_id' => $instance->id ]) }}" title="{{ __('Dodajte ručno korisnika na obuku') }}">
        <div class="rm-ci-w">
