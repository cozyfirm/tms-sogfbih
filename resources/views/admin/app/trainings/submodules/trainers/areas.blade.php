...
@section('page-title') {{ ($user->name ?? '') . __(' - stručna sprema') }} @endsection
    ...
    <div class="content-wrapper content-wrapper-p-15">
        <div class="form__info">
            <div class="form__info__inner">
                <form action="{{ route('system.admin.trainings.submodules.trainers.areas.update') }}" method="POST" id="js-form">
