        ...
        <div class="rm-card" title="{{ __('Informacije o edukaciji') }}">
            <div class="rm-card-header">
                <div class="text__part" title="{{ __('Fakultet i univerzitet') }}">
                    <h5><a href="{{ route('system.admin.trainings.submodules.trainers.edit-education', ['id' => $education->id ]) }}" class="hover-yellow-text" title="{{ __('Uredite informacije') }}">{{ $education->school ?? '' }}</a></h5>
...
<div class="rm-card-icons">
    <a href="{{ route('system.admin.trainings.submodules.trainers.create-education', ['username' => $user->username ]) }}" title="{{ __('Stručna sprema') }}" class="open-add-author">
        <div class="rm-ci-w">
